...
public class LeftMiss : MonoBehaviour {
    float fDt = 0.0f;
	...
	void Update () {
        ...
        {
            if (MoveEvent == false)
                MyTransform.Translate(0.0f, Random.Range(9.0f, 11.0f) * Speed * Time.deltaTime, 0.0f);
            else
                MyTransform.Translate(0.0f, Random.Range(-9.0f, -11.0f) * Speed * Time.deltaTime, 0.0f);
        }
    ...
    void bPax_1Check()
    {
        ...
        if (fDt > 1.0f)
        {
            ...
            if (MyTransform.position.x > -0.58f)
            {
                bPax_1 = false;
                bPax_2 = true;
                fDt = 0.0f;
    ...
    void bPax_2Check()
    {
        ...
        if (MyTransform.position.x < -8.47156f)
        {
            bPax_2 = false;
        }
    }
